  ...
  return (
    ...
    >
      ...
      <motion.h3
        ...
        className="text-gray-400 font-Header text-sm md:text-lg sm:text-md mt-10 tracking-wider "
      >
        I&apos;m a <span className="text-AAsecondary">Software Engineer</span> with
        strong <span className="text-AAsecondary">problem-solving skills</span>,
        ...
        with a diverse range of technologies, including modern web applications.
        <br className="3xl:block hidden" /> I enjoy tackling challenging
        projects that drive <span className="text-AAsecondary">innovation</span>{" "}
        ...
        dynamic projects that push the boundaries of{" "}
