  ...
  return (
      <div className={` ${props.className} bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4 `}>
        ...
        <div className="flex flex-row space-x-8">
          <ClickableIcon
            href={"https://github.com/kalsariyadarshan"}
            Icon={GithubIcon}
          />
          <ClickableIcon
            href={"https://www.linkedin.com/in/darshan-kalsariya-364768280/"}
            Icon={LinkedinIcon}
          />
          <ClickableIcon
            href={"https://www.instagram.com/dars._29/"}
            Icon={InstagramIcon}
          />
        </div>
    ...
    text-sm  space-y-2  "
          >
            <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
              Designed & Built by Darshan Kalsariya
            </span>
          </div>
        </a>
      </div>
