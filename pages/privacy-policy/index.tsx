    ...
    <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        <div className="px-4 py-5 sm:p-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Privacy Policy for darshankalsariya.com</h1>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The website <a href="https://darshankalsariya.com" className="text-blue-600 hover:text-blue-800 transition duration-300">darshankalsariya.com</a> serves as my personal portfolio where I share my resume and software projects.
            </p>
            <p className="text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              Email: <a href="mailto:your.email@example.com" className="text-blue-600 hover:text-blue-800 transition duration-300">darshankalsariya29@gmail.com</a>
            </p>
          </section>
        </div>
      </div>
